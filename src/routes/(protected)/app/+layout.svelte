...
<div class="flex h-screen bg-base-900">
	<aside
		class="grid transition-[grid-template-columns] duration-300 ease-in-out sidebar-open:grid-cols-[1fr] sidebar-closed:grid-cols-[0fr]"
	>
		<div class="flex min-w-fit flex-col overflow-hidden border-r border-base-700 bg-base-800">
			...
			<div class="flex h-16 shrink-0 items-center border-b border-base-700 px-3">
				<div
					class="flex w-full items-center sidebar-open:justify-start sidebar-closed:justify-center"
				>
			...
			<nav class="flex flex-1 flex-col gap-1 overflow-hidden p-2">
				<a
					href={resolve('/app')}
					class="flex cursor-pointer items-center rounded-md px-3 py-2 text-base-300 transition-colors hover:bg-base-700 sidebar-open:justify-start sidebar-closed:justify-center"
				>
					<!-- Icon - Fixed 48px width, always centered -->
					<div class="flex w-12 flex-none items-center justify-center">
			...
			<div class="shrink-0 border-t border-base-700 p-2">
				<button
					...
					class="flex w-full cursor-pointer items-center rounded-md px-3 py-2 text-base-300 transition-colors hover:bg-base-700 sidebar-open:justify-start sidebar-closed:justify-center"
				>
					<!-- Icon - Fixed 48px width, always centered -->
					<div class="flex w-12 flex-none items-center justify-center">
						<svg
